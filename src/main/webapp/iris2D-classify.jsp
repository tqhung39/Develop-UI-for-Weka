...
<html>
    <head>
        ...
        <title>Iris2D Classification</title>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-primary">
  <a class="navbar-brand pl-5 text-light">Iris2D Classification</a>
</nav>
            <div class="container">
                <div id="classify">
                    </br>
                    ...
                    <div class="col-md-4 pt-3 bg-light">                       
                        ...
                        <br>
                        <a href="iris2D-comparison.jsp"><button class="btn btn-primary" type="button" onclick="saveResult()">Compare</button></a>
                            <br>
                            </div>                   
